...
## 2. Mental Model: What the Agent Is (and Isn't)
...
## 3. The Configuration File Hierarchy
...
## 6. Designing Tasks the Agent Can Complete
...
## 7. Optimizing Issue and Prompt Structure
...
## 9. Embedding the Agent in CI and Team Process
